...
export const legalDocs: LegalDoc[] = [
  {
    ...
    sections: [
      ...
      { h: "Where your data lives", p: ["Today, everything is stored on your device only. When account sync launches, your data will be stored on servers in the European Union. We will update this policy before that happens and ask you again where consent is required."] },
      { h: "Who we share it with", p: ["Nobody, for money, ever. We do not sell data and we do not use it for advertising.", "Processors that help us run the service (hosting, email delivery, crash reporting) will be listed here with their location before we start using them.", "Other users see what you share to the feed and your public profile. A private account hides your workouts from people you have not accepted."] },
