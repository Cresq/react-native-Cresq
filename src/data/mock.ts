...
export const otherPosts: Post[] = [
  ...
  { id: "p5", userId: "u7", name: "Noah de Groot", meta: "Push · 2 days ago", caption: "Deload week. Light, fast, done in forty.", workout: [{ name: "Bench press", sets: [{ kg: 50, reps: 8, type: "warmup" }, { kg: 80, reps: 6 }, { kg: 80, reps: 6 }, { kg: 80, reps: 6 }, { kg: 80, reps: 6 }] }, { name: "Overhead press", sets: [{ kg: 45, reps: 8 }, { kg: 45, reps: 8 }, { kg: 45, reps: 8 }] }, { name: "Incline dumbbell press", sets: [{ kg: 26, reps: 10 }, { kg: 26, reps: 10 }, { kg: 26, reps: 10 }] }, { name: "Cable fly", sets: [{ kg: 15, reps: 15 }, { kg: 15, reps: 15 }] }, { name: "Triceps pushdown", sets: [{ kg: 30, reps: 12 }, { kg: 30, reps: 12 }, { kg: 30, reps: 12 }] }], exercises: [{ name: "Bench press", detail: "4 × 6 · 80 kg" }, { name: "Overhead press", detail: "3 × 8 · 45 kg" }, { name: "Incline dumbbell press", detail: "3 × 10 · 26 kg" }, { name: "Cable fly", detail: "2 × 15 · 15 kg" }, { name: "Triceps pushdown", detail: "3 × 12 · 30 kg" }], stats: [{ value: "41", unit: "min" }, { value: "6.2k", unit: "kg" }, { value: "15", unit: "sets" }], likes: 6, comments: 0 },
];
