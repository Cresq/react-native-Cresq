...
export const otherPosts: Post[] = [
  { id: "p2", userId: "u2", name: "Sara de Vries", title: "Legs", meta: "yesterday", place: "TrainMore Amsterdam Zuid", photo: photos.gym2, caption: "Pause squats, 5 × 5 at 90 kg.", workout: [{ name: "Back squat", sets: [{ kg: 60, reps: 5, type: "warmup" }, { kg: 90, reps: 5 }, { kg: 90, reps: 5 }, { kg: 90, reps: 5 }, { kg: 90, reps: 5 }, { kg: 90, reps: 5 }] }, { name: "Romanian deadlift", sets: [{ kg: 80, reps: 8 }, { kg: 80, reps: 8 }, { kg: 85, reps: 6 }] }, { name: "Leg press", sets: [{ kg: 140, reps: 12 }, { kg: 150, reps: 10 }, { kg: 150, reps: 10 }] }, { name: "Walking lunge", sets: [{ kg: 16, reps: 12 }, { kg: 16, reps: 12 }] }, { name: "Calf raise", sets: [{ kg: 60, reps: 15 }, { kg: 60, reps: 15 }, { kg: 60, reps: 12, type: "failure" }] }], stats: [{ value: "64", unit: "min" }, { value: "9.8k", unit: "kg" }, { value: "16", unit: "sets" }], commentList: [{ name: "Tom Bakker", text: "Pause squats at 90, strong.", avatar: photos.gym3 }, { name: "Nick Li", text: "That bar speed though.", avatar: photos.selfie }], likes: 12, comments: 3 },
  { id: "p4", userId: "u4", name: "Lisa Jansen", title: "Full body", meta: "today", place: "Basic-Fit Utrecht Centrum", caption: "Third session this week. Deadlift finally moved.", workout: [{ name: "Deadlift", sets: [{ kg: 60, reps: 5, type: "warmup" }, { kg: 90, reps: 5 }, { kg: 90, reps: 5 }, { kg: 90, reps: 5 }] }, { name: "Bench press", sets: [{ kg: 45, reps: 8 }, { kg: 45, reps: 8 }, { kg: 45, reps: 8 }] }, { name: "Lat pulldown", sets: [{ kg: 40, reps: 10 }, { kg: 40, reps: 10 }, { kg: 40, reps: 10 }] }, { name: "Plank", sets: [{ kg: 0, reps: 45 }, { kg: 0, reps: 45 }, { kg: 0, reps: 45 }] }], record: "New record, Deadlift 90 kg", exercises: [{ name: "Deadlift", detail: "3 sets" }, { name: "Bench press", detail: "3 sets" }, { name: "Lat pulldown", detail: "3 sets" }, { name: "Plank", detail: "3 sets" }], stats: [{ value: "48", unit: "min" }, { value: "4.1k", unit: "kg" }, { value: "12", unit: "sets" }], commentList: [{ name: "Sara de Vries", text: "Finally! That one has been stuck for weeks.", avatar: photos.gym2 }, { name: "Nick Li", text: "90 for reps next month.", avatar: photos.selfie }], likes: 15, comments: 4 },
  { id: "p3", userId: "u3", name: "Tom Bakker", title: "Arms", meta: "yesterday", place: "SportCity Rotterdam", photo: photos.gym3, caption: "Preacher curls to finish. Forearms gone.", workout: [{ name: "Barbell curl", sets: [{ kg: 30, reps: 10 }, { kg: 30, reps: 10 }, { kg: 32.5, reps: 8 }] }, { name: "Triceps pushdown", sets: [{ kg: 30, reps: 12 }, { kg: 32.5, reps: 12 }, { kg: 35, reps: 10 }] }, { name: "Hammer curl", sets: [{ kg: 14, reps: 12 }, { kg: 14, reps: 12 }] }, { name: "Overhead extension", sets: [{ kg: 25, reps: 12 }, { kg: 25, reps: 12 }, { kg: 25, reps: 10 }] }, { name: "Preacher curl", sets: [{ kg: 20, reps: 12 }, { kg: 20, reps: 10 }, { kg: 15, reps: 12, type: "drop" }] }], stats: [{ value: "41", unit: "min" }, { value: "4.2k", unit: "kg" }, { value: "14", unit: "sets" }], commentList: [{ name: "Sara de Vries", text: "Forearms will forgive you by Thursday.", avatar: photos.gym2 }], likes: 8, comments: 1 },
  { id: "p5", userId: "u7", name: "Noah de Groot", title: "Push", meta: "2 days ago", place: "Fit For Free Den Haag", caption: "Deload week. Light, fast, done in forty.", workout: [{ name: "Bench press", sets: [{ kg: 50, reps: 8, type: "warmup" }, { kg: 80, reps: 6 }, { kg: 80, reps: 6 }, { kg: 80, reps: 6 }, { kg: 80, reps: 6 }] }, { name: "Overhead press", sets: [{ kg: 45, reps: 8 }, { kg: 45, reps: 8 }, { kg: 45, reps: 8 }] }, { name: "Incline dumbbell press", sets: [{ kg: 26, reps: 10 }, { kg: 26, reps: 10 }, { kg: 26, reps: 10 }] }, { name: "Cable fly", sets: [{ kg: 15, reps: 15 }, { kg: 15, reps: 15 }] }, { name: "Triceps pushdown", sets: [{ kg: 30, reps: 12 }, { kg: 30, reps: 12 }, { kg: 30, reps: 12 }] }], exercises: [{ name: "Bench press", detail: "4 sets" }, { name: "Overhead press", detail: "3 sets" }, { name: "Incline dumbbell press", detail: "3 sets" }, { name: "Cable fly", detail: "2 sets" }, { name: "Triceps pushdown", detail: "3 sets" }], stats: [{ value: "41", unit: "min" }, { value: "6.2k", unit: "kg" }, { value: "15", unit: "sets" }], likes: 6, comments: 0 },
];
